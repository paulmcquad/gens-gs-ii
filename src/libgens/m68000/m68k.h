...
struct _m68ki_cpu_core
{
  ...
  int  (*bkpt_ack_callback)(m68ki_cpu_core *cpu, unsigned int ir);           /* Breakpoint Acknowledge */
#endif
  ...
  int  (*cmpild_instr_callback)(m68ki_cpu_core *cpu, unsigned int, src unsigned int ir);           /* Called when a CMPI.L #v, Dn instruction is encountered */
#endif
#if M68K_RTE_HAS_CALLBACK
  int  (*rte_instr_callback)(m68ki_cpu_core *cpu);           /* Called when a RTE instruction is encountered */
#endif
