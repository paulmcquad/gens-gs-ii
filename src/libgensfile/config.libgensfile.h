 ...
 * config.libgensfile.h.in: LibGensFile configuration. (source file)       *
 *                                                                         *
...
#ifndef __LIBGENS_CONFIG_LIBGENSFILE_H__
#define __LIBGENS_CONFIG_LIBGENSFILE_H__
...
#endif /* __LIBGENS_CONFIG_LIBGENSFILE_H__ */
